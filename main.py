...
def process(text,who):
    if isCommand(text):
        ...
        text="Instruction kuda olunga padika theriyatha....athu olunga anupuna than olunga solluvan."
        return text
